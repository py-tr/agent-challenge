...
const PENDING_ITEMS = [
  // Highest priority: calendar conflict detected this morning
  {
    ...
    metadata:  JSON.stringify({
      eventA: { id: "cal-ev-001", title: "Q2 Business Review", start: "2026-04-10T14:00:00" },
      eventB: { id: "cal-ev-002", title: "Sarah 1:1",          start: "2026-04-10T14:00:00" },
      suggestedSlots: ["2026-04-10T15:30:00", "2026-04-11T10:00:00"],
    }),
    status:    "pending",
    priority:  1,
